...
class NoticeboardStudentwise extends Component{
    constructor(props){
        super(props)
        this.state = {
            notices:""
    ...
    componentDidMount(){
        api.student.notices.view().then(data => {
            const {notices} = data
            this.setState({
                notices
            })
                            ...
                            <tbody>
                                {notices && notices.map((item,id) => {
                                    return <tr>
                                        ...
                                        <td>
                                            {item.image_url &&
                                                <a download className="btn btn-primary btn-sm" href={item.image_url}>Attachment</a>
                                            }
                                        </td>
...
export default NoticeboardStudentwise