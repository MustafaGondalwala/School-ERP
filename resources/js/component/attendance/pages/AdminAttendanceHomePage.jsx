    ...
    <div>
        ...
        <div className="container-fluid mt--6">
          <div className="row card-wrapper">
                ...
                <ColComponent title={"View Class/Section Wise Student Attendance"} description={"View Class/Wise Student Attendance in System"} button_text="Enter" link={"/admin/attendance/view-class-wise-student-attendance"} />
