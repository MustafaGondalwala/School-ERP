...
export const StudentLeftSide = ({student_id}) => {
  return(
        ...
        <div className="navbar-inner">
          ...
          <ul className="navbar-nav">
                <li className="nav-item">
                  ...
                  <Link to="/student/view-result" className="nav-link" >
                    <i className="ni ni-ungroup text-orange" />
                    <span className="nav-link-text">View Results</span>
                  </Link>
                  <Link to={"/student/homework/"+student_id} className="nav-link" >
                    <i className="ni ni-ungroup text-orange" />
                    <span className="nav-link-text">HomeWork</span>
                  </Link>
                  <Link to={"/student/noticeboard"} className="nav-link" >
                    <i className="ni ni-ungroup text-orange" />
                    <span className="nav-link-text">Noticeboard</span>
                  </Link>
                  <Link to={"/student/online-test"} className="nav-link" >
                    <i className="ni ni-ungroup text-orange" />
                    <span className="nav-link-text">Online Test</span>
                  </Link>
                </li>
              </ul>
          </div>
...
export class StudentTopNavbar extends Component{
  constructor(props){
    super(props)
    this.state = {
    ...
    logout(e){
     ...
     render () {
      ...
      const {parent_childs,user,logout} = this.props
       return (
         <div>
         <StudentLeftSide student_id={user.info.id}/>
           <div className="main-content" id="panel">
             <StudentTopNavbar  user={user} logout={logout}/>
             {this.props.children}
           </div>
         </div>
       )
...
export const StudentDashboardHome = () => [
    <div>Student Dashboard Home</div>
]
