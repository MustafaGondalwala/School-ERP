         ...
         <div className="navbar-inner">
           <div className="collapse navbar-collapse" id="sidenav-collapse-main">
             ...
             <li className="nav-item">
               <Link className="nav-link active" to="/clerk/student">
             ...
             <li className="nav-item">
               <Link className="nav-link" to="/clerk/fees" >
             ...
             <li className="nav-item">
               <Link className="nav-link" to="/clerk/timetable">
             ...
             <li className="nav-item">
               <Link to="/clerk/exam" className="nav-link" >
...
export class ClerkTopNavbar extends Component{
  constructor(props){
    super(props)
    this.state = {
       ...
       return (
         ...
         <ClerkLeftSide />
           <div className="main-content" id="panel">
             <ClerkTopNavbar  user={user} logout={logout}/>
             {this.props.children}
           </div>
         </div>
       )
...
export const ClerkDashboardHome = () => [
    <div>Clerk Dashboard Home</div>
]
...
export default connect(mapStateToProps,{ logout })(ClerkDashboard);