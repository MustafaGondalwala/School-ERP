...
class StudentParentCurrentHomeWork extends Component{
    ...
    render(){
        ...
        return(
            <div>
                <EmptyHeader mainHeader="HomeWork" header="Current"/>
                <BodyComponent>
                    <CardComponent title="Current HomeWork" back_link={`/${user_type}/homework/${student_id}`}>
                        <Table>
                            <Thead>
                                <th>Sr no.</th>
                                <th>Subject</th>
                                ...
                                { studentCurrent_homework[student_id] !== undefined &&
                                    studentCurrent_homework[student_id].map((item,id) => {
                                        ...
                                        return <tr>
                                            ...
                                            :
                                                <td><Button primary sm onClick={e => this.sendEvent("submit",item)}>Submit</Button></td>
...
export default connect(mapStateToProps,{setStudentCurrentHomeWorkDispatch,setStudentCurrentHomeWork})(StudentParentCurrentHomeWork);