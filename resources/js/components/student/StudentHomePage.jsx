            ...
            <div className="col-lg-4">
              <div className="card">
                <div className="card-body">
                  ...
                  <Link to="/admin/student/add-new-admission-student" className="btn btn-primary">Enter</Link>
                </div>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="card">
                <div className="card-body">
                  ...
                  <Link to="/admin/student/admission-list" className="btn btn-primary">Enter</Link>
                </div>
              </div>
            </div>
            <div className="col-lg-4">
            ...
            <div className="col-lg-4">
              <div className="card">
                <div className="card-body">
                  ...
                  <Link to="/admin/student/view-student-login" className="btn btn-primary">Enter</Link>
                </div>
              </div>
            </div>
        </div>
